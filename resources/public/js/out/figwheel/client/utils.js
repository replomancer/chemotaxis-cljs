...
return (new CustomEvent(event_name,(function (){var obj27165 = {"detail":data};
return obj27165;
})()));
} else {
...
var f = (function (){var pred__27172 = cljs.core._EQ_;
var expr__27173 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__27172.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__27173))){
return ((function (pred__27172,expr__27173){
return (function (p1__27166_SHARP_){
return console.warn(p1__27166_SHARP_);
});
;})(pred__27172,expr__27173))
} else {
if(cljs.core.truth_(pred__27172.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__27173))){
return ((function (pred__27172,expr__27173){
return (function (p1__27167_SHARP_){
return console.debug(p1__27167_SHARP_);
});
;})(pred__27172,expr__27173))
} else {
if(cljs.core.truth_(pred__27172.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__27173))){
return ((function (pred__27172,expr__27173){
return (function (p1__27168_SHARP_){
return console.error(p1__27168_SHARP_);
});
;})(pred__27172,expr__27173))
} else {
return ((function (pred__27172,expr__27173){
return (function (p1__27169_SHARP_){
return console.log(p1__27169_SHARP_);
});
;})(pred__27172,expr__27173))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__27176){
...
var eval_fn = cljs.core.get.call(null,map__27177__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__27179_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__27181,(0),null);
var v = cljs.core.nth.call(null,vec__27181,(1),null);
...
}catch (e27186){if((e27186 instanceof Error)){
var e = e27186;
return not_found;
} else {
throw e27186;
...
//# sourceMappingURL=utils.js.map?rel=1534859000970
