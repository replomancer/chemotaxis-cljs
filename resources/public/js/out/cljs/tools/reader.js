...
var G__26846 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__26846;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__26847 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__26847,ch);
...
if(("\\" === ch__$1)){
var ch_26848__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_26848__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_26848__$2);
} else {
}

var G__26849 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__26849;
continue;
}
}
...
var vec__26857 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26857,(0),null);
var start_column = cljs.core.nth.call(null,vec__26857,(1),null);
...
var G__26860 = cljs.core.conj_BANG_.call(null,a,form);
a = G__26860;
continue;
}
}
...
var _STAR_read_delim_STAR_26861 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_26861;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__26862 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26862,(0),null);
var start_column = cljs.core.nth.call(null,vec__26862,(1),null);
...
var vec__26865 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26865,(0),null);
var end_column = cljs.core.nth.call(null,vec__26865,(1),null);
...
var vec__26868 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26868,(0),null);
var start_column = cljs.core.nth.call(null,vec__26868,(1),null);
...
var vec__26871 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26871,(0),null);
var end_column = cljs.core.nth.call(null,vec__26871,(1),null);
...
var vec__26874 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26874,(0),null);
var start_column = cljs.core.nth.call(null,vec__26874,(1),null);
...
var vec__26877 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26877,(0),null);
var end_column = cljs.core.nth.call(null,vec__26877,(1),null);
...
var sb = (function (){var G__26880 = (new goog.string.StringBuffer());
G__26880.append(initch);
...
var G__26882 = (function (){var G__26881 = sb;
G__26881.append(ch);

return G__26881;
})();
var G__26883 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__26882;
ch = G__26883;
continue;
}
...
switch (G__26886) {
case "\\":
var G__26890 = (function (){var G__26887 = sb;
G__26887.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__26887;
})();
var G__26891 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__26890;
ch = G__26891;
continue;
...
break;
default:
var G__26892 = (function (){var G__26888 = sb;
G__26888.append(ch);

return G__26888;
})();
var G__26893 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__26892;
ch = G__26893;
continue;
...
var line = cljs.core.nth.call(null,vec__26897,(0),null);
var column = cljs.core.nth.call(null,vec__26897,(1),null);
...
var vec__26902 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__26902,(0),null);
var column = cljs.core.nth.call(null,vec__26902,(1),null);
...
var vec__26907 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__26907,(0),null);
var column = cljs.core.nth.call(null,vec__26907,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__26912 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26912,(0),null);
var start_column = cljs.core.nth.call(null,vec__26912,(1),null);
...
var vec__26915 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26915,(0),null);
var end_column = cljs.core.nth.call(null,vec__26915,(1),null);
...
var G__26918 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__26918,true,null,opts,pending_forms);
...
var G__26919 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__26919)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__26919)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__26919)){
...
var _STAR_suppress_read_STAR_26920 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_26920;
}});
...
var G__26921 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__26921,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__26921,rdr,first_line);
...
var G__26925 = matched;
var G__26926 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__26925;
finished = G__26926;
continue;
} else {
...
var _STAR_suppress_read_STAR_26927 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_26927;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env26928 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__26929 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__26929,"(");
...
var G__26930 = (i + (1));
var G__26931 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3922__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env26928;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__26932 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__26932);
...
var G__26933 = cljs.core.next.call(null,s__$1);
var G__26934 = ret;
s__$1 = G__26933;
r = G__26934;
continue;
...
var G__26935 = cljs.core.next.call(null,s);
var G__26936 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__26935;
key_vals = G__26936;
continue;
} else {
...
var gensym_env26940 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env26940;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__26941 = token;
var G__26941__$1 = (((G__26941 == null))?null:cljs.core.subs.call(null,G__26941,(1)));
var G__26941__$2 = (((G__26941__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__26941__$1));
var G__26941__$3 = (((G__26941__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__26941__$2));
var G__26941__$4 = (((G__26941__$3 == null))?null:cljs.core.symbol.call(null,G__26941__$3));
if((G__26941__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__26941__$4);
}
})():(function (){var G__26942 = token;
var G__26942__$1 = (((G__26942 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__26942));
if((G__26942__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__26942__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
}catch (e26949){if((e26949 instanceof Error)){
var e = e26949;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__26953,reader){
...
var eof = cljs.core.get.call(null,map__26954__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4499__auto___26962 = arguments.length;
var i__4500__auto___26963 = (0);
while(true){
if((i__4500__auto___26963 < len__4499__auto___26962)){
args__4502__auto__.push((arguments[i__4500__auto___26963]));

var G__26964 = (i__4500__auto___26963 + (1));
i__4500__auto___26963 = G__26964;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq26960){
var G__26961 = cljs.core.first.call(null,seq26960);
var seq26960__$1 = cljs.core.next.call(null,seq26960);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26961,seq26960__$1);
});


//# sourceMappingURL=reader.js.map?rel=1534859000199
